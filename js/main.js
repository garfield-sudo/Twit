$(document).ready(function () {
    ...
    fetch(`${API}?_page=${page}&_limit=10&_sort=create_timestamp&_order=desc`)
      ...
      .then((data) => {
        ...
        data.forEach((post, index) =>
          postsList.append(buildPostsListItem(post, index))
        );
      });
  }
          ...
          <li id="${post.id}" class="post box">
            <article class="media">
              ...
              <div class="media-content">
                <div class="content">
                  <p>
                    <strong>John Smith</strong> <small>@johnsmith</small> <small>${calcTimedifference(
  ...
  function calcTimedifference(time1) {
    ...
    if (diffSecs > 60 * 60 * 24)
      return makeElapsedTime(diffSecs / 60 / 60 / 24, "days");
  }
